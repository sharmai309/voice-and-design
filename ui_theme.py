...
.st-key-cta_banner .stButton button[kind="primary"] { background: #6E1B29 !important; border-radius: 0 0 20px 20px !important; border-top: 1px solid rgba(255,255,255,0.15) !important; padding-top: 16px !important; padding-bottom: 16px !important; font-size: 1rem !important; }
.st-key-cta_banner .stButton button[kind="primary"]:hover { background: #7f2030 !important; transform: none; }
...
div[data-testid="stAlert"] * { color: #1F2937 !important; opacity: 1 !important; }
...
section.main p, section.main li, section.main strong, section.main em { color: #111827 !important; opacity: 1 !important; }
[data-testid="stMetricLabel"], [data-testid="stMetricLabel"] *,
[data-testid="stMetricValue"], [data-testid="stMetricValue"] * { color: #111827 !important; opacity: 1 !important; }
</style>
"""
...
'@ | Out-File -FilePath ui_theme.py -Encoding utf8